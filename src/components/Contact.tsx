      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-gray-300 mb-6">
                    ...
                    projects. Feel free to reach out using any of these methods.
                  </p>

                  <div className="mt-6 p-6 border border-green-500/20 rounded-xl bg-gray-900/50">
                    <p className="text-gray-300 italic">
                      "I'm passionate about creating clean, efficient solutions
                      that solve real problems. Let's build something amazing
                      together!"
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="ml-4 overflow-hidden">
                      ...
                      <p
                        className="text-white group-hover:text-green-400 transition-colors truncate"
                        title={email}
                      >
                        {email}
                      </p>
                  ...
                  <a
                    href="https://wa.me/message/IHXTOP6QANKBG1"
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center p-4 border border-gray-800 rounded-lg hover:border-green-500/50 hover:bg-gray-800/50 transition-colors group"
                  >
                  ...
                  <div className="pt-6">
                    ...
                    <div className="flex flex-col space-y-4">
                      <a
                        href="https://www.linkedin.com/in/kinuthia-lawrence-b0374324a/"
                        target="_blank"
                        rel="noreferrer"
                      ...
                      >
                        ...
                        <span className="text-sm text-gray-300 group-hover:text-blue-400">
                          linkedin.com/in/kinuthia-lawrence
                        </span>
                      </a>
                      <a
          ...
          <div className="mt-12 text-center">
            ...
            <a
              href={`mailto:${email}`}
              className="inline-flex items-center px-8 py-3 bg-gradient-to-r border border-white rounded-full from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 transform hover:-translate-y-1 transition-all duration-200 shadow-lg shadow-green-900/30"
            >
